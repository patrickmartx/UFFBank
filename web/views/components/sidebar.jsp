<div class="sidebar">
  <div>
    <a class="logo" href="/UFFBank/Login">
      <img 
    ...
    <nav class="menu">
      <a class="link" href="/UFFBank/Deposit">
      ...
      <a class="link" href="/UFFBank/Transfer">
      ...
      <a class="link" href="/UFFBank/Withdrawal">
        ...
        Saque</a>
      <a class="link" href="/UFFBank/Investment">
  ...
  <form action="/UFFBank/Logout" method="post" class="link">
    <button type="submit">
